...
const nav: NavItem[] = [
  ...
  {
    href: '/cosecha',
    label: 'Dashboard Cosecha',
    group: 'Cosecha & Exportación',
    badge: '🍒',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {(() => {
          ...
          return groups.map((group) => (
            <div key={group} className="mb-4">
              {group && (
                <p className="px-3 mb-1 text-[10px] font-bold uppercase tracking-widest text-primary-500">
                  {group}
                </p>
              )}
